      ...
      body: Stack(
        children: <Widget>[
          PageView.builder(
            ...
            itemBuilder: (context, index) => _pages![index] == null ? Center(
              child: widget.progressIndicator ?? const CircularProgressIndicator.adaptive(),) : _pages![index]!,
          ),
          if (widget.showIndicator && !_isLoading) _drawIndicator(),
        ],
      ),
      floatingActionButton: widget.showPicker && widget.document.count > 1 ? FloatingActionButton(
        elevation: 4.0,
