...
class _ZoomableWidgetState extends State<ZoomableWidget> {
  ...
  void _onScaleUpdate(ScaleUpdateDetails details) {
    ...
    const marginSize = Size(100.0, 100.0);
    ...
    if ((widget.singleFingerPan && details.scale == 1.0) || (widget.multiFingersPan && details.scale != 1.0)) {
      final panRealOffset = (details.focalPoint - _zoomOriginOffset + _previousPanOffset * _previousZoom) / _zoom;
      ...
      if (widget.panLimit == 0.0) {
        ...
        final widthFactor = sqrt(marginOffset.dx.abs()) / marginSize.width;
        final heightFactor = sqrt(marginOffset.dy.abs()) / marginSize.height;
        marginOffset = Offset(
